...
ALL_HIDDEN_IMPORTS = [
    ...
    "py_noita.simulation.sand_simulation",
    "py_noita.simulation.spatial_hash",
    "py_noita.simulation.transmutation",
    # Entities
    "py_noita.entities",
    "py_noita.entities.player",
    "py_noita.entities.enemy",
    "py_noita.entities.rigid_body",
    "py_noita.entities.ik_rig",
    "py_noita.entities.corpse",
    # Weapons & Deckbuilding
    "py_noita.weapons",
    ...
    "py_noita.rendering.liquid_shaders",
    ...
    # Audio Synthesis
    "py_noita.audio",
    "py_noita.audio.manager",
    "py_noita.audio.sound_catalog",
    "py_noita.audio.adaptive_music",
    "py_noita.audio.spatial",
    "py_noita.audio.acoustics",
    # System, Persistence & Modding
    "py_noita.system",
